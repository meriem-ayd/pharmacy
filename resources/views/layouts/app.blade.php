        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav nav-height">
                    ...
                    <li class="nav-item">
                         <a class="nav-link" href="{{route('listeDCI')}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="" aria-expanded="false" aria-controls="page-layouts">
                        ...
                        <div class="collapse" id="page-layouts">
                            {{-- <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{route('ajouterDCI')}}">Ajouter dci</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{route('liste_dci')}}">Consulter la liste DCI</a></li>
                            </ul> --}}
                        </div>
                    </li>
